...
class DDPSpawnPlugin(ParallelPlugin):
    ...
    def configure_ddp(self):
        ...
        self._model = DistributedDataParallel(
            LightningDistributedModule(self.model) if self.model.trainer.state.fn == TrainerFn.FITTING
            else self.model, device_ids=self.determine_ddp_device_ids(), **self._ddp_kwargs
        )
